...
2. Install dependencies:
   ```bash
   pip install numpy pandas matplotlib seaborn lasio scikit-learn
   ```
3. Open the notebook:
   ```bash
   jupyter notebook Olasunkanmi_olagboye_Week_4_Assignment__1_.ipynb
   ```
4. Ensure `Data2.las` is in the same directory as the notebook, then run all cells.

> You can also run it directly on [Google Colab](https://colab.research.google.com/) by uploading the notebook and the LAS file.

## Author

**Olasunkanmi Olagboye**  
Week 4 Assignment — Petrophysical Machine Learning Modelling
